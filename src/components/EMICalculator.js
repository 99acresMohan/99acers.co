    ...
    return (
        <div style={styles.page}>
            <div style={styles.container}>
                <button onClick={() => navigate('/')} style={styles.backBtn}>← Back to Properties</button>

                <h2 style={styles.title}>Home Loan EMI Calculator</h2>
                <p style={styles.subtitle}>Plan your property purchase in Rohini with ease</p>
                ...
                <div style={styles.flexBox}>
                    ...
                    <div style={styles.resultSection}>
                        ...
                        <button style={styles.applyBtn} onClick={() => alert("Redirecting to Bank Partners...")}>
                            Apply for Loan
                        </button>
                    </div>
                </div>
